...
- Materials in use: `res://resources/cel_character.tres` and
  `res://resources/cel_ground.tres` — each is the base shader with
  `res://resources/cel_outline_material.tres` as its `next_pass`.
